...
class SaleWizard(models.TransientModel):
    ...
    session_student_ids = fields.Many2many(comodel_name='res.partner', string='Students in Current Session', related='session_id.student_ids')
        ...
        if session_product_id:
            for student in self.student_ids:
                order_id = self.env['sale.order'].create({
                    ...
                    'order_line': [(0,0,{'product_id': session_product_id.id, 'price_unit': session_id.total_price})]
                })
